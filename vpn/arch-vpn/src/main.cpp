...
int main(int argc, char** argv) {
    ...
    const std::string config_file = "/home/zenyyxz/dotfiles/vpn/arch-vpn/config.json";
    const std::string profiles_file = "/home/zenyyxz/dotfiles/vpn/arch-vpn/profiles.json";

    Config config;
    config.load_from_json(config_file); 
    ProfileManager profile_manager(profiles_file);
    Process vpn_process(config_file);
